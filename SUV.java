/**
 * Class to save all the SUV details
 * This class contains all the calculations and details of the SUV
 * It extends Vehicle so it has all the features of a vehicle
 */
public class SUV extends Vehicle {

    private double rentRate = 90;
    private double lateFee;
    private int seats;

    SUV(String VehicleId, int Year, String Make, String Model, int status, VehicleType vehicleType, String color, String ownerName) {
        super(VehicleId, Year, Make, Model, status, vehicleType, color, ownerName);
        seats = vehicleType.getSUVSeats();
    }
    ...
    /**
     * Method used to get details of SUV with their rental history
     * Prints the rental record of SUV
     */
