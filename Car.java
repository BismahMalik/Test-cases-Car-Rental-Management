...
public class Car extends Vehicle {
    ...
    Car(String VehicleId, int Year, String Make, String Model, int status, VehicleType vehicleType, String color, String ownerName) {
    ...
    public Car(String vehicleID, int year, String make, String model, int i, VehicleType vehicleType) {
    	super(vehicleID, year, make, model, i, vehicleType);
